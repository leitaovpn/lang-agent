"""修复层测试：发给 LLM 的历史与 checkpoint 持久化历史都必须满足 tool_call 不变式。
...
from lang_agent.core.repair import repair_messages_for_llm, repair_state_for_checkpoint


# ---- repair_messages_for_llm：LLM 拷贝修复（只修最后一条 AIMessage 起的尾部） ----
